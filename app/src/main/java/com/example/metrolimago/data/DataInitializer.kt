...
object DataInitializer {
    private val estaciones = listOf(
        ...
        Estacion(4,  "AEROPUERTO", "Línea 2", "Conexión al Aeropuerto Jorge Chávez."),
        ...
        Estacion(9,  "SAN MARCOS", "Línea 2", "Cerca a la UNMSM."),
    ...
    fun preload(db: MetroDatabase) {
        CoroutineScope(Dispatchers.IO).launch {
            val dao = db.estacionDao()
            if (dao.getAll().isEmpty()) {
                dao.insertAll(estaciones)
            }
        }
    }
}
